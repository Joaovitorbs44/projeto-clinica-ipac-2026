...
$mensagem = urlencode(
  "Olá! Gostaria de agendar uma consulta na IPAC. Poderiam me passar mais informações sobre os horários disponíveis? Por favor."
);
  ...
  <div class="relative z-10 flex flex-col justify-center gap-5 sm:gap-6 md:gap-8 px-5 sm:px-6 md:px-10 lg:px-12 xl:px-20 2xl:px-32 py-16 sm:py-20 md:py-24 lg:py-24">
    ...
    <h3 class="text-[22px] sm:text-[24px] md:text-[28px] lg:text-[24px] xl:text-[28px] text-black font-cormorant leading-tight max-w-lg">
      ...
      <span class="text-[#9aaa00]">
        Transforme sua relação com você mesmo.
      </span>
    </h3>
    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
      ...
      <a
        ...
        class="flex justify-center items-center gap-2 text-sm text-white font-medium
               px-6 sm:px-7 md:px-8 py-3
               rounded-lg
               hover:opacity-90
               transition
               bg-gradient-to-r from-[#687237] to-[#d1e254]"
      >
      ...
      <a
        ...
        class="flex justify-center items-center gap-2
               text-sm text-[#9aaa00] font-medium
               px-6 sm:px-7 md:px-8 py-3
               rounded-lg
               border border-[#9aaa00]
               hover:bg-[#9aaa0020]
               transition
               bg-white"
      >
